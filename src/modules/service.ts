...
export class Service {
  ...
  async defineService(
    ...
    const author = await this.client.keys.show(baseTx.from);
  ...
  async bindService(
    ...
    const provider = await this.client.keys.show(baseTx.from);
  ...
  async withdrawTax(
    ...
    const trustee = await this.client.keys.show(baseTx.from);
